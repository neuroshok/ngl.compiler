...
class parser_sequence_vector : public ::testing::Test
{
protected:
    void SetUp() override
    {
...
TEST_F(parser_sequence_vector, basic)
{
...
TEST_F(parser_sequence_vector, repeat)
{
...
TEST_F(parser_sequence_vector, circular)
{
    auto seq = shapes.add_element<ngl::shape_sequence>(underscore, letters, underscore);
    {
        ngl::parser lx{ shapes };
